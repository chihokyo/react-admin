...
> 这里的表单验证已经是 *Ant v3*的标准了，现在升级到了V4，于是做法上有很多不同，大概就是简化了很多操作。
>
> [从V3升级到V4的官方示例 Migrate to v4](https://ant.design/components/form/v3)
...
> 关于组件周期最新的*React*版本已经不推荐使用*componentWillMount* 这次课程里我都改成了constructor
...
> 比如那种一次性获取大量数据的例如商品一览，这样就不太适用于**前台分页**，利用后台分页可以**减轻压力**。
>
